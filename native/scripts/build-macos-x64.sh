...
RUNTIME_DIR="$NATIVE_PKG_DIR/runtimes/osx-x64/native"
...
echo "=== PjSip.Net Native Build — macOS x64 ==="
...
SWIG_SCRIPT="$SCRIPT_DIR/generate-swig.ps1"
